...
<context>
    ...
    <message id="intfuorit-section-desc-breached-sites">
        ...
        <oldsource>A \&quot;breach\&quot; is an incident where a site's data has been illegally accessed by hackers and then released publicly. Review the types of data that were compromised (email addresses, passwords, credit cards etc.) and take appropriate action, such as changing passwords.</oldsource>
        <translation>Ein &lt;i&gt;Datenleck/Breach&lt;/i&gt; ist ein Vorfall bei dem Hacker illegal Zugriff auf Daten einer Internetseite erhielten und diese dann veröffentlichten. Prüfen Sie die Art der kompromittierten Daten (E-Mail-Adressen, Passwörter, Kreditkarten, usw.) und leiten Sie entsprechende Schritte ein, wie das Ändern der Passwörter.</translation>
    </message>
